    ...
    return [
        ...
        },
        {
            ...
            "description": (
                ...
                "field naming that limit when it applies, an empty `tests` list "
                "for such a language means «unknown» not «none», and "
                "`candidate_callers_from_text` carries call sites found by text "
                "search that the parser missed — leads to open, never to be "
                "reported as graph-resolved relations. "
